    ...
    return (
        <form onSubmit={videoData ? handleDownload : handleView}>
            <div className="w-full h-screen flex flex-col items-center justify-center lg:bg-black sm:bg-slate-900 max-sm:bg-slate-900 md:bg-slate-900">
                ...
                <footer className="w-full absolute bottom-3 flex items-center justify-center gap-x-3">
                    <p
                    ...
                    >
                        <FaGithub size={25} className="mr-2 max-sm:text-[10px]" />
                    </p>
                    <p
                    ...
                    <p className="text-slate-600 flex items-center max-sm:text-[14px] text-md justify-center cursor-pointer transition-all duration-300 hover:text-slate-300">
